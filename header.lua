...
plugin.name = "Blaze - Fury Warrior"
...
--Are we a mage?
local is_valid_class = player_class == enums.class_id.WARRIOR
...
--Are we a Fury Warrior?
local is_valid_spec = player_spec_id == spec_id.get_spec_id_from_enum(spec_id.spec_enum.FURY_WARRIOR)

-- If we are not Fury Warrior then dont load the plugin
